...
CMakeFiles/format:
	cd /home/tmp/ParallelProgramming-/Opencl && clang-format -i `find source -type f -iname '*.c'` `find include -type f -iname '*.h'`
	cd /home/tmp/ParallelProgramming-/Opencl && clang-format -i `find source -type f -iname '*.cpp'` `find include -type f -iname '*.hpp'`
